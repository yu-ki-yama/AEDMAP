    ...
    $(function () {
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        //TODO モックデータ
                        coordinateArray = [{'latitude': latitude, 'longitude': longitude},{'latitude': latitude+0.001, 'longitude': longitude+0.001}]
        ...
        function circleAbleAED(map, coordinateArray) {
            ...
            coordinateArray.forEach(function(coordinateList, index) {
                ...
                let clickEvent = marker.on( 'click', function(e) {  clickEvt(e); })
